...
console.log('Todos los arreglos :', numeros, mascotasJS);


// Filtrar numeros que sean menores que 5
const numerosFiltrados = numeros.filter( x => x < 5 );

console.log(`Numeros sin filtrar: ${numeros}`);
console.log(`Numeros filtrados: ${numerosFiltrados}`);


// Filtrar mascotas que sean solo perros
const mascotasFiltradosAnimales = mascotasJS.filter( x => x.animal === 'Perro' );

console.log('Todas las mascotas :', mascotasJS);
