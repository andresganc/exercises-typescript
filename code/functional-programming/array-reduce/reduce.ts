...
const resultado = numeros2.reduce((acc, el) => acc + el, 0)
...
const indexed: any = mascotas2.reduce((acc, el) => ({
    ...acc,
    [el.nombre]: el,
}), {})
...
const anidado:any = [1, [2, 3], 4, [5]];
const plano = anidado.reduce((acc:any, el:any) => acc.concat(el), [])   // concat / concatenar
