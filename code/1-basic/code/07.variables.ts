...
var variable1: string = "Sebastian es muy juicioso";
var variable2: string = "Correcto";
var variable3: number = 3;
let variable4: string = "";
let variable5: string = "Sebastian";
let variable6: string = "Gomez";
