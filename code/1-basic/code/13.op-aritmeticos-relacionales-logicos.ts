...
// console.log("7" == 7)   // Arroja verdadero asi sean de diferente tipo - NO PERMITIDO EN TS

// Comparacion de tipo de dato y valor / ===    ( Buena practica porque evalua si son del mismo valor y tipo )
// console.log("7" === 7)  // Arroja falso por que no son el mismo tipo de dato (String y Number) - NO PERMITIDO EN TS

// Malas practicas - comparacion 2 y 3  los arroja como verdadero y no deberia de ser asi. 
console.log(7 == 7)
// console.log("7" == 7) - NO PERMITIDO EN TS
// console.log(0 == false) - NO PERMITIDO EN TS
...
console.log(!true)
console.log(!false)
// console.log( (9 === 9) || ('9' === 9) )     // - NO PERMITIDO EN TS
// console.log( (9 === 9) && ('9' === 9) )     // - NO PERMITIDO EN TS