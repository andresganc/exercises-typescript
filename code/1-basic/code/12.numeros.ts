...
console.log( parseInt(num_entero) )
//console.log( num_entero.to() )
...
console.log( num_decimal.toString() )       // En TS
//console.log( parseFloat(num_decimal)      // En JS
